...
const TESTIMONIALS = [
    {
        ...
        text: "Anees architected our Request to Pay system from scratch and onboarded over 4,000 merchants. His understanding of payment protocols and TLV encoding is exceptional — he delivered production-grade code under tight deadlines.",
        name: "Ahmed Khalil",
        position: "Technical Lead",
        company: "DPL (AXIAN Group)",
    },
    {
        avatar: "/assets/imgs/template/avatar/avatar-7.webp",
        text: "His .NET expertise and clean architecture approach transformed how we build enterprise solutions. Anees migrated our platform from .NET 7 to 8 with zero downtime and introduced domain-driven design patterns that the entire team adopted.",
        name: "Fatima Zahra",
    ...
    },
    {
        ...
        text: "Anees built our real estate platform end-to-end — from the Node.js backend to the React frontend. He shipped fast, communicated clearly, and the codebase he left behind was easy to maintain and extend.",
        name: "Omar Hassan",
        position: "CTO",
        company: "Axontick",
    },
    {
        avatar: "/assets/imgs/template/avatar/avatar-6.webp",
        text: "The bulk notification system Anees designed handles 700K to 800K messages in under 8 minutes. He optimized every layer — from database queries to message queue throughput. That system has been rock-solid in production.",
        name: "David Mwangi",
        position: "Product Manager",
        company: "Mixx by Tigo (Tanzania)",
    },
    {
        avatar: "/assets/imgs/template/avatar/avatar-7.webp",
        text: "Anees brought AI tooling into our daily workflow — setting up MCP servers and internal agent tooling that accelerated the entire team's delivery. He is equal parts engineer and force multiplier.",
        name: "Saad Raza",
