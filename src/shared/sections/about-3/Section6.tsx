...
const SKILL_CARDS = [
    {
        ...
        tags: [tag(1, ".NET Core"), tag(3, "C#"), tag(4, "ABP.io")],
        score: 98,
    },
    {
        thumb: "/assets/imgs/pages/img-149.webp",
        title: "Frontend Development",
        tags: [tag(3, "Angular"), tag(1, "React"), tag(4, "TypeScript")],
        score: 92,
    },
    {
        thumb: "/assets/imgs/pages/img-150.webp",
        title: "Fintech & Payments",
        tags: [tag(7, "EMV QR"), tag(8, "Stripe"), tag(9, "HyperPay")],
        score: 95,
    },
    {
        ...
        tags: [
            ...
            tag(11, "Kubernetes"),
            tag(12, "Azure DevOps", "dark-mode-invert"),
        ],
        score: 90,
    },
    {
        ...
        tags: [tag(13, "PostgreSQL"), tag(14, "Redis"), tag(15, "RabbitMQ")],
        score: 94,
    },
];
                ...
                <div className="row pb-100 align-items-lg-end">
                    ...
                    <div className="col-xxl-5 col-lg-7 text-lg-end ms-auto">
                        <h6 className="fw-600 fz-font-lg">
                            I leverage .NET, Angular, React, and cloud-native tooling to build reliable backend systems, payment platforms, and enterprise applications that scale.
                        </h6>
                    </div>
                </div>
            </div>
