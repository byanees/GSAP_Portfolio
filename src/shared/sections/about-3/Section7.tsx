...
const FAQ_ITEMS = [
    {
        ...
        answer: ".NET Core, C#, Angular, React, microservices, Docker, Kubernetes, with deep expertise in fintech payment systems and enterprise architecture.",
        open: true,
    },
    {
        id: "collapseTwo",
        ...
        answer: "Large-scale fintech platforms, telecom payment systems, enterprise certificate workflows, real estate platforms, and insurance enrollment systems across Africa, Middle East, and Europe.",
        open: false,
    },
    {
        id: "collapseThree",
        ...
        answer: "Yes — I use Cursor, Claude, and GitHub Copilot daily as part of my delivery workflow. I've also built internal agent tooling and MCP servers for my team at Systems Limited.",
        open: false,
    },
    {
        id: "collapseFour",
