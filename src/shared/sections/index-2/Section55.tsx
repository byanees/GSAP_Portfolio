...
const AVATARS = [
    { src: "/assets/imgs/custom/custom-5.png", alt: "Muhammad Anees", thumbClass: "thumb-slide-1" },
    { src: "/assets/imgs/custom/custom-4.png", alt: "Muhammad Anees", thumbClass: "thumb-slide-2" },
    { src: "/assets/imgs/custom/custom-3.png", alt: "Muhammad Anees", thumbClass: "thumb-slide-3" },
    { src: "/assets/imgs/custom/custom-2.png", alt: "Muhammad Anees", thumbClass: "thumb-slide-4" },
    { src: "/assets/imgs/custom/custom-1.png", alt: "Muhammad Anees", thumbClass: "thumb-slide-5" },
];

const QUOTE_TEXT = (
    <>
        I architect and build scalable full-stack systems -- from .NET Core
        microservices to Angular frontends -- that power fintech and enterprise platforms.
    </>
);
