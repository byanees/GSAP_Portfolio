...
const SERVICES = [
    {
        ...
        description: "I build robust backends with .NET Core, C#, ASP.NET Core, Domain-Driven Design, clean architecture, microservices, REST APIs, and EF Core.",
        textWhite: true,
    },
    {
        type: "card-2",
        ...
        description: "I craft Angular micro-frontends, React apps, and TypeScript-driven UIs including responsive admin portals and analytics dashboards.",
        textWhite: false,
    },
    {
        type: "card-3",
        ...
        description: "I develop EMV QR payments, TLV encoding, Request to Pay flows, and payment gateway integrations with HyperPay and Stripe.",
        textWhite: true,
    },
    {
        type: "card-2",
        ...
        icon: ICON_BUILD,
        title: "Cloud & DevOps",
        description: "I containerize with Docker, orchestrate on Kubernetes, and set up CI/CD pipelines with Jenkins, Azure DevOps, Redis, RabbitMQ, and Elastic Stack.",
        textWhite: false,
    },
];
                    ...
                    <div className="row pb-60">
                        <div className="col-lg-2 col-md-3">
                            <span className="at-btn common-black bg-transparent mb-10 rounded-0 p-0">
                                <span className="text-uppercase">
                                    <span className="text-1">what I do</span>
                                    <span className="text-2">what I do</span>
                                </span>
                                <i>
                                    {ARROW_SVG}
                                    {ARROW_SVG}
                        ...
                        <div className="col-lg-6 col-md-9">
                            <h3 className="reveal-text lh-1">
                                <RevealText>
                                    Building scalable backends, modern frontends, and reliable fintech systems.
                                </RevealText>
                            </h3>
                        </div>
                        <div className="col-lg-3 col-md-6 ms-auto mt-md-0 mt-4">
                            ...
                            <div className="d-flex gap-3 pt-30">
                                ...
                                <span className="neutral-900">
                                    I design and build enterprise-grade systems that are clean, testable, and built to scale.
                                </span>
                            </div>
                        </div>
                    </div>
