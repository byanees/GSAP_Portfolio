...
const PORTFOLIO_CARDS = [
    {
        ...
        tags: ["USSD", "Mobile App", "Microservices", ".NET Core"],
    },
    {
        classList: "col-lg-6",
        link: "#",
        ...
        metricPrefix: "",
        metricValue: "100",
        metricLabel: "End-to-End Automation",
        tags: ["Angular", "HyperPay", "Clean Architecture", "Systems Limited"],
    },
];
                    ...
                    <div className="row align-items-end g-4">
                        <div className="col-xxl-6 col-lg-6">
                            ...
                            <h3 className="reveal-text mb-0">
                                <RevealText>Real-world engineering projects with measurable impact</RevealText>
                            </h3>
                        </div>
                                ...
                                <div className="card_case__studies-card">
                                    <div className="card_case__studies-left">
                                        ...
                                        <h4 className="card_case__studies-title">
                                            <Link to="#">
                                                EMV QR Payment <br /> System
                                            </Link>
                                        </h4>
                                        <p className="card_case__studies-desc">
                                            I built a peer-to-peer QR payment system conforming to EMV standards
                                            with TLV encoding for AXIAN Group's Mixx Tanzania platform, enabling
                                            seamless mobile payments across the ecosystem.
                                        </p>
                                        <div className="card_case__studies-metrics">
                                            <div className="card_case__studies-metric">
                                                <h4 className="card_case__studies-metric-value mb-0">
                                                    <OdometerCounter count={800} prefix="" suffix="K" />
                                                </h4>
                                            ...
                                            <div className="card_case__studies-metric">
                                                <h4 className="card_case__studies-metric-value mb-0">
                                                    <OdometerCounter count={4000} prefix="+" suffix="" />
                                                </h4>
                                                <span className="card_case__studies-metric-label">
                                                    Merchants Served
                                                </span>
                ...
                <div className="container pt-120">
                    <div className="row g-5">
                            ...
                            <div className="award-description d-flex gap-5 pe-lg-5">
                                ...
                                <div className="content">
                                    <h5 className="revert-text mb-0 reveal-text">
                                        <RevealText>
                                            I build production-grade fintech platforms, microservice architectures,
                                            and enterprise systems. I combine clean architecture, DDD, and modern
                                            DevOps to deliver systems that scale reliably.
                                        </RevealText>
                                    </h5>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-6">
                            <span className="neutral-500 fw-600 text-uppercase">companies I&apos;ve worked with</span>
