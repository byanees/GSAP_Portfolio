                    ...
                    <div className="col-lg-4">
                        ...
                        >
                            ...
                            <h2 className="text-white reveal-text mb-60 pb-60 border-bottom-opacity">
                                Endorsed by colleagues and engineering leads on LinkedIn
                            </h2>
                            <div className="d-flex align-items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-white fz-font-sm mb-0 mt-2">
                                        Consistently rated for <br /> reliability and technical depth
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="d-flex flex-lg-nowrap flex-wrap gap-5 p-md-5 p-4">
                                ...
                                <div className="content">
                                    <p className="text-white fz-font-3xl fw-400 mb-50 lh-base">
                                        Anees consistently delivers production-ready code with clean architecture and solid test coverage. His work on the EMV QR payment system and bulk notification scheduler demonstrated exceptional problem-solving under tight deadlines.
                                    </p>
                                    <h5 className="text-white fw-500">Engineering Lead</h5>
