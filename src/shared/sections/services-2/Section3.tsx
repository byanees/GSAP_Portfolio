...
const FAQ_ITEMS = [
    ...
    },
    {
        ...
        answer: "Yes. I build Angular micro-frontends and React applications on the frontend, and .NET Core microservices on the backend, with full CI/CD deployment pipelines.",
        open: false,
    },
    {
        id: "collapseThree",
        num: "3",
        question: "What's your experience with payment systems?",
        answer: "I've built EMV-compliant QR payment systems, Request to Pay features used by 4,000+ merchants, and integrated payment gateways like HyperPay and Stripe.",
        open: false,
    },
    {
        id: "collapseFour",
