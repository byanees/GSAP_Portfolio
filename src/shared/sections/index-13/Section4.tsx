            ...
            <div className="sec-4-home-13__card">
                ...
                <div className="sec-4-home-13__bottom">
                    ...
                    <div className="sec-4-home-13__contact">
                        ...
                        <a className="sec-4-home-13__contact-row" href="mailto:info@klarus.io">
                            <span className="sec-4-home-13__contact-mail at-rise-animation text-white">info@klarus.io</span>
